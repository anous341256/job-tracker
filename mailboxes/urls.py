...
urlpatterns = [
    ...
    path('messages/<int:pk>/ai/schedule/', views.analyze_schedule, name='analyze-schedule'),
    ...
    path('messages/ai/schedule/batch/', views.batch_analyze_schedule, name='batch-analyze-schedule'),
